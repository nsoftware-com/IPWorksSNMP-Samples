# 
# IPWorks SNMP 2024 Python Edition - Sample Project
# 
...
try:
  ...
  if mgr.get_snmp_version() == 3:
    print("\r\nDiscovering agent...")
    mgr.discover()
    print("Discovered agent (engine id " + mgr.get_remote_engine_id().decode('utf-8') + ").\r\n")
  ...
  if mgr.get_error_status() == 0:
    for i in range(mgr.get_obj_count()):
      print(mgr.get_obj_id(i) + " = " + mgr.get_obj_value(i).decode('utf-8'))
  else:
